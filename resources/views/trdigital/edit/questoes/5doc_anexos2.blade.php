        ...
        <div class="accordion" id="accordionExample">
            ...
            <div class="accordion-item">
                ...
                <div id="d" class="accordion-collapse collapse" aria-labelledby="headingThree"
                    ...
                    <div class="icon">
                        <div class="col-md-12 iframe-container">
                            <iframe src="{{ asset('storage/' . $n_processo->Doc_Anexo2->Doc_Anexo2_Anexo4) }}"></iframe>
                        </div>
                        <a class="btn btn-primary" href="{{ asset('storage/' . $n_processo->Doc_Anexo2->Doc_Anexo2_Anexo4) }}"
                            target="_blank">
                            <i class="bi bi-file-earmark-pdf-fill"></i> Ver arquivo
                        </a>
                    </div>
