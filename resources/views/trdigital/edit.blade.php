                                    ...
                                    <div class="row match-height">
                                        <div class="col-12">
                                            ...
                                            <div class="text-center mb-5">
                                                ...
                                                <p> Preencha as informções da sua TR DIGITAL </p>
                                                      ...
                                                      <div class="col-10">
                                                          <div class="list-group" id="list-tab" role="tablist">
                                                              <a class="list-group-item list-group-item-action active"
                                                                  ...
                                                                  role="tab" aria-controls="list-home"><big><b> Órgão Concedente </b></big>
                                                                  </a>
                                        ...
                                        <div class="col-lg-10">
                                          <select name="Orgao_Concedente" id="Orgao_Concedente" class="form-control custom-select" required>
                                                ...
                                                <option value="{{ $n_processo->Orgao_Concedente }}">
                                                    <img src="" width="20px"> {{ $n_processo->Orgaos->Sigla }} - {{ $n_processo->Orgaos->Nome }}
                                                </option>
                                        </select>
